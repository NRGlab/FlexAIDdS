...
int    write_MODEL_pdb(bool isFirst, bool isLast, int nModel, FA_Global* FA,atom *atoms, resid* residue,char outfile[], char remark[]); // write multi-MODEL PDB files as result
